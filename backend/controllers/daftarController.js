...
// FUNGSI UNTUK MENDAPATKAN JADWAL CUSTOMER
...
// FUNGSI UNTUK "TUKAR SESI" (INI ADALAH VERSI YANG BENAR)
exports.reschedulePendaftaran = async (req, res) => {
  ...
  try {
    ...
    pendaftaran.markModified('jadwalSesi'); // Tandai bahwa array telah dimodifikasi
    await pendaftaran.save();
